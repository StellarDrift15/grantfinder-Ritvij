    ...
    >
      ...
      <div className="flex items-center gap-2">
        {sponsor.contact_email && (
          <a href={`mailto:${sponsor.contact_email}`} className="flex items-center gap-1.5 rounded-lg px-3.5 py-2 text-xs font-semibold text-white transition-colors" style={{ background: "linear-gradient(120deg,#8B5CF6,#38BDF8 55%,#22D3EE)" }}>
        ...
        {sponsor.website_url && (
          <a href={sponsor.website_url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 rounded-lg border border-gf-line hover:bg-gf-panel-hi px-3.5 py-2 text-xs font-semibold text-gf-mid transition-colors">

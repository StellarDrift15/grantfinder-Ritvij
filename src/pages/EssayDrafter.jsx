...
export default function EssayDrafter() {
  ...
  return (
    <Shell active="">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="font-display text-xl font-bold text-gf-hi">AI grant essay drafter</h1>
          <p className="text-sm text-gf-low">Generate a first draft from your prompt, then get clarity rewrites.</p>
        </div>
      </div>
              ...
              {!reviewing && suggestions && suggestions.length > 0 && (
                <div className="rounded-2xl border border-[rgba(52,211,153,0.25)] bg-gf-panel p-6">
                  <div className="flex items-center gap-2 mb-1">
                    <Sparkles size={16} className="text-gf-mint" />
